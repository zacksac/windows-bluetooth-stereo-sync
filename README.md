# windows-bluetooth-stereo-sync (music)
Turn and play together  any  two bluetooth speakers into a synchronized stereo sound system on windows .
...
4.  Open the windows bluetooth stero sync app select input source as Cable Output (VB-Audio vitrtual (In:16 Out:0)
5.  On windows sound set CABLE Input (VB Audio Virtual Cable) as default playback device .
6.  On windows bluetooth stero sync app select the bluetooth speaker 1 and 2 you want to use adjust delay and click start to enjoy dual stereo sync sound .
